...
*[예제 보기]( https://github.com/kdzlvaids/esp2017/tree/master/%EC%98%88%EC%A0%9C/%EB%AC%B8%EC%A0%9C%204:%20Makefile%20-%20%ED%97%A4%EB%8D%94%20%EC%9D%98%EC%A1%B4%EC%84%B1%20Makefile%20%EC%9E%91%EC%84%B1 )*
...
-   가) 하지만 설정 화면을 살펴보던 철이는 뭔가 이상하다는 것을 발견하였다. 아래 그림과 같이
    ...
    ![menuconfig]( https://raw.githubusercontent.com/kdzlvaids/esp2017/figures/menuconfig.png )

    ### 예상답안

    ```bash
    $ export ARCH="arm"
    $ export CROSS_COMPILE="armv8l-linux-gnueabihf-"
    ```
